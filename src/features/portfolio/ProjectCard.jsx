...
function ProjectCard({ project }) {
  ...
  const handlePrev = () => {
    console.log(modalImageCurrentIndex);
    setModalImageCurrentIndex(
      (prevValue) =>
        (prevValue + project.images.length - 1) % project.images.length
    );
  };
  ...
  const handleNext = () => {
    console.log(modalImageCurrentIndex);
    setModalImageCurrentIndex(
      (prevValue) => (prevValue + 1) % project.images.length
    );
  };
  ...
  return (
    <>
      <div
        className='mx-auto max-w-md shadow-2xl rounded-lg'
        onClick={toggleModal}
        id='card'>
        ...
        <div className='border-b border-gray-50' id='card_footer'>
          ...
          <p className='py-2 text-center text-theme-white'>
      ...
      {isModalOpen && (
        <ProjectCardModal isOpen={isModalOpen} toggleModal={toggleModal}>
          <div className='w-11/12 md:w-4/5 lg:w-1/2' id='modal'>
            <div id='modal_header'>
              <button
                className='px-5 py-3 font-semibold bg-red-700 text-white hover:bg-red-600'
                onClick={toggleModal}>
                X
              </button>
            </div>
            ...
            <div id='modal_body'>
              <div id='modal_slider'>
                <img
                  ...
                  src={project.images[modalImageCurrentIndex]}
                  alt={project.name}
                />
            ...
            <div className='pt-2 pb-4' id='modal_footer'>
              ...
              <p className='py-4 text-center text-theme-white'>
                {project.techStack.toUpperCase()}
              </p>
